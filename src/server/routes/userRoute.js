...
router.post('/signup', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, email, password, user, hashedPassword, newUser, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 5:
                if (user) {
                    return [2 /*return*/, res.status(409).json({ message: 'User name already exist' })];
                }
                return [3 /*break*/, 7];
            case 6:
                error_1 = _b.sent();
...
router.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, user, matchPassword, token, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 2:
                ...
                return [2 /*return*/, res.status(402).json({ message: "User Not found" })];

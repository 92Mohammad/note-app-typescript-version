...
router.get('/notes', jwtAuthenticate_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                userId = req.headers["userId"];
                return [4 /*yield*/, note_model_1.default.create({ note_title: noteTitle, userId: userId })];
            case 1:
                newNote = _a.sent();
                if (newNote) {
                    console.log('newNote : ', newNote);
                    return [2 /*return*/, res.status(201).json({ message: 'Notes created successfully' })];
                }

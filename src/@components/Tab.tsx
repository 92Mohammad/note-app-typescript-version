...
export const Tab = ({id, title, tab, selectedTab, onSelect, onRemove}: TabProps) => {
    ...
    return (
        <div className={`${selectedTab && selectedTab._id === id ? " bg-gray-900" : "bg-gray-700 "} flex items-center gap-2 px-2  justify-between h-9 cursor-pointer slate-950 border-r`} >
            <span 
